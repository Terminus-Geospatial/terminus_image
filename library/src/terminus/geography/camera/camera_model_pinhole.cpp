...
camera_model_pinhole::camera_model_pinhole( const math::Point3d&    camera_origin,
                                            ...
                                            double                  pitch,
                                            [[maybe_unused]] distortion_Base::ptr_t  distortion )
...
/**************************************************/
Result<math::Vector3d> camera_model_pinhole::pixel_to_vector( [[maybe_unused]] const math::Point2d& pix ) const
{
    /*
...
/*      Set the Camera Matrix     */
/**********************************/
Result<void> camera_model_pinhole::set_camera_matrix( [[maybe_unused]] const math::Matrix<double,3,4>& p )
{
    /*
    ...
    if( std::fabs( R( 0, 1 ) ) >= 1.2 )
    {
        ...
        return outcome::fail( error::Error_Code::UNDEFINED,
                              sout.str() );
    }
...
/************************************************************************************/
Result<void> camera_model_pinhole::apply_transform( [[maybe_unused]] const math::Matrix_4x4& transform )
{
    /*
...
/**********************************************************/
Result<void> camera_model_pinhole::apply_transform( [[maybe_unused]] const math::Matrix_3x3& rotation,
                                                    [[maybe_unused]] const math::Vector3d&   translation,
...
/********************************************************************************/
Result<camera_model_pinhole::ptr_t> camera_model_pinhole::scale_camera( [[maybe_unused]] double scale ) const
{
    /*
    if( scale == 0 )
    {
...
/*          Convert to String           */
/****************************************/
std::string camera_model_pinhole::to_string( [[maybe_unused]] size_t offset ) const
{
    throw std::runtime_error("Not Implemented Yet");
    return "";
}
