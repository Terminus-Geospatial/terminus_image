...
#include <terminus/image/pixel/pixel_accessor_memstride.hpp>
...
class Image_Memory : public Image_Base<Image_Memory<PixelT>>
{
    public:
                               ...
                               size_t planes = 1 )
        {
            ...
            else
            {
                ...
                if( !data )
                {
                    ...
                    return outcome::fail( error::Error_Code::OUT_OF_MEMORY,
                                          sout.str() );
                }
        ...
        */
        prerasterize_type prerasterize([[maybe_unused]] const math::Rect2i& bbox ) const
        {
            return *this;
        }
